...
var drop_menu =
  '<table class="drop-menu" style="width:275px;font-family: Verdana, sans-serif;background-color: white;">' +
...
function ContentMethod() {
  let drop_menu =
    ...
    "<img src=" +
    sAvatarUrl +
    ' class="img-circle" style="width:30px;height: 30px;margin-left: 20px; margin-right:5px;">' +
    '<span style="font-weight:bold;">' +
    sNickname +
    "</span>" +
    "</td>" +
    ...
    "  </td>" +
    '<td style="flex-basis: 40%;border-right: 1px solid #e9e9e9;">' +
    ' <span id="follows" style="font-weight:bold;">' +
    iFollows +
    "</span>" +
    " <br>" +
    "<span>关注</span>" +
    " </td>" +
    ' <td style="flex-basis: 30%;">' +
    '<span id="followeds" style="font-weight:bold;">' +
    iFolloweds +
    "</span>" +
    "<br>" +
    " <span>粉丝</span>" +
    ...
    '<td style="margin-left: 20px;"><i class="fa fa-yelp" aria-hidden="true" style="padding-right:10px;"></i>等级</td>' +
    '<td style="flex-grow: 2;visibility: hidden;"></td>' +
    '<td style="margin-right: 20px;font-weight:bold;">Lv.' +
    iLevel +
    "  </td>" +
    "  </tr>" +
    "<tr>" +
    ...
    '  <td style="flex-grow: 2;visibility: hidden;"></td>' +
    '<td style="margin-right: 20px;font-weight:bold;">' +
    iListenSongs +
    "</td>" +
    "</tr>" +
    "<tr>" +
